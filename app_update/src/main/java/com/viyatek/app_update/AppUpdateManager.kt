...
class AppUpdateManager (
    ...
    private val updateSharedPreferences by lazy {
...
// Checks that the platform will allow the specified type of update.
                ...
                when {
                    appUpdateInfo.isUpdateTypeAllowed(AppUpdateType.IMMEDIATE) && inAppUpdateType == 1 -> {
                        try {
                            ...
                            updateSharedPreferences.applyPrefs(
                                Statics.IS_UPDATE_REQUIRE_HANDLED,
                                true
                            )
    ...
    private fun popUpSnackBarForCompleteUpdate(appUpdateManager: AppUpdateManager) {
        updateSharedPreferences.applyPrefs(Statics.IS_UPDATE_REQUIRE_HANDLED, 0)
